...
void RF1D::evalDrift(double* values, const double* x) const
  ...
  long double Gp =( erf(x[0]) - 0.2e1*x[0] 
   ...
   std::cout << "pow1:" << 1.0/std::pow(x[0],2)<< std::endl;
   std::cout << "pow2:" << 1.0/std::pow(lelp,2)<< std::endl;
   std::cout << "pow3:" << 1.0/(lelp*lelp)<< std::endl;
   std::cout << "p1:" << lelp<< std::endl;
