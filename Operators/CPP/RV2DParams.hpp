...
long double T0 =  20e3*1.1604505e4;   // test particle temperature  [eV]*[K/eV] = [K] 
long double mp = 1.6726e-27;         // Mass proton
long double mee = 9.1094e-31;      // Mass electron
long double m = mp*2;                // Mass testparticle
long double q = 1.6022e-19;          // elementary charge
